        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody id="detail">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="pelaksana{{$no}}" class="form-control" value="{{$item->pelaksana}}">
                    </td>
                    <td>
                        <input type="text" name="peserta{{$no}}" class="form-control" value="{{$item->peserta}}" >
                    </td>
                    <td>
                        <input type="number" name="keterangan{{$no}}" class="form-control"  value="{{$item->keterangan}}">
                    </td>
                    <td>
